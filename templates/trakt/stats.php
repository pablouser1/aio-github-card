<svg id="svg" width="<?= $this->e($params->width) ?>" height="235" viewBox="0 0 <?= $this->e($params->width) ?> 235"
    ...
    <image y="10" width="100%" height="50"
        href="data:image/svg+xml;base64,<?= $this->getLogo("trakt", $params->theme) ?>" />
    <text class="header" x="<?= $this->e($params->width / 4) ?>" y="85"><?= $this->e($params->username) ?>'s
        stats</text>
