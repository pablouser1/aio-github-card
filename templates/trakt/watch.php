<svg id="svg" width="<?= $this->e($params->width) ?>" height="190" viewBox="0 0 <?= $this->e($params->width) ?> 190"
    ...
    <image x="180" y="10" width="160" height="60"
        href="data:image/svg+xml;base64,<?= $this->getLogo("trakt", $params->theme) ?>" />
    <g transform="translate(144, 65)">
        <text class="header" x="10" y="30"><?= $this->e($params->username) ?>
            <?= $data->isWatching ? 'is watching' : 'watched' ?></text>
        ...
        <?php if ($data->type === 'episode'): ?>
            ...
            <g transform="translate(10, 70)">
                ...
                <g transform="translate(0, 20)">
                    ...
                    <g>
                        <a target="_blank"
                            href="<?= $this->e($this->trakt_show_url($data->show->ids->slug, $data->episode->season)) ?>">
        ...
        <?php else: ?>
            ...
            <g transform="translate(10, 70)">
                <a target="_blank" href="<?= $this->e($this->trakt_movie_url($data->movie->ids->slug)) ?>">
                    <text class="title scroll"><?= $this->e($data->movie->title) ?>
                        (<?= $this->e($data->movie->year) ?>)</text>
                </a>
            </g>
        <?php endif ?>
    </g>
